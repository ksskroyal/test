 ...
 * 
 * Realisation of a client to work with CookingRecipe  JSON data remotely.
 * 
 */
...
int main(){
    ...
    while(!exit){
        ...
        std::cout << "3. Add CookingRecipe" << std::endl;
        std::cout << "4. Find CookingRecipe by ID" << std::endl;
        std::cout << "5. Save current data" << std::endl;
        std::cout << "6. Execute data.json" << std::endl;
        ...
        switch(com_number){
            ...
            case 1:
            {
                ...
                if(res && res->status == 200){
                    std::cout << "Successfully generated " << numbers << " CookingRecipes" << std::endl;
                }else{
                    std::cout << "Failed to generate CookingRecipes" << std::endl;
            ...
            {   
                std::string restName;
                std::cout << "Enter CookingRecipe name : ";
                std::cin >> restName;
                ...
                if(res && res->status == 200){
                    ...
                    std::cout << "Failed to add a new CookingRecipe" << std::endl;
                    std::cout << "error status : " << res->status << std::endl;
                }
            ...
            case 4:
            {
                ...
                if(res && res->status == 200){
                    ...
                    std::cout << "Failed to find a CookingRecipe" << std::endl;
                    std::cout << "error status : " << res->status << std::endl;
                }
                break;
            }
                ...
                case 6:
            {
                ...
                std::cin >> t1 >> t2 >> c1 >> c2;
                std::string req="/execute?t1="+std::to_string(t1)+"&t2="+std::to_string(t2)+"&c1="+std::to_string(c1)+"&c2="+std::to_string(c2);
